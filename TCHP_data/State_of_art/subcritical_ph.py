...
# ---------------------------------------
h_min, h_max = 150, 600
transition_lower = p_crit_bar - 10
transition_upper = p_crit_bar + 10


fig = plt.figure(figsize=(8,6))
ax = fig.add_subplot(111)
# Colored regions
ax.add_patch(patches.Rectangle((h_min, 10), h_max - h_min, transition_lower - 10, color='skyblue', alpha=0.4))
ax.add_patch(patches.Rectangle((h_min, transition_lower), h_max - h_min, 20, color='yellowgreen', alpha=0.4))
...
ax.text(490, 70, "Transition", fontsize=14, color='black')
