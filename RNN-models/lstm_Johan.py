...
# # ------------------------
# torch.save(model.state_dict(), "LSTM_Johan/lstm_model.pth")
# joblib.dump(scaler_input, "LSTM_Johan/scaler_input.pkl")
# joblib.dump(scaler_output, "LSTM_Johan/scaler_output.pkl")
...
model = LSTMCellModel(input_size, hidden_size, output_size, num_layers)
model.load_state_dict(torch.load("LSTM_Johan/lstm_model.pth"))
model.eval()

scaler_input = joblib.load("LSTM_Johan/scaler_input.pkl")
scaler_output = joblib.load("LSTM_Johan/scaler_output.pkl")
