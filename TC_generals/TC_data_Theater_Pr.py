...
eff_Ex = []
with open(r'C:\Users\ali.salame\Desktop\Thermodynamics\data files\TC experiments\pcharged = 40, Theater_Pr.csv') as csv_file:    
...
import os
save_dir = r'C:\Users\ali.salame\Desktop\plots\Thesis figs\TC_data\pcharged_Pr'
...
# plt.legend(fontsize=12)
# plt.tight_layout()
# plt.savefig(os.path.join(save_dir, "Qheater_pcharged_Pr.eps"), format='eps')
...
# # plt.grid(True)
# plt.tight_layout()
# plt.savefig(os.path.join(save_dir, "Qcooler_pcharged_Pr.eps"), format='eps')
# # Figure 3: Pmotor
# plt.figure()
# for i in range(3):
#     start, end = i * 5, (i + 1) * 5
...
# # plt.grid(True)
# plt.tight_layout()
# plt.savefig(os.path.join(save_dir, "Pmech_pcharged_Pr.eps"), format='eps')
...
# # plt.grid(True)
# plt.tight_layout()
# plt.savefig(os.path.join(save_dir, "Tout_pcharged_Pr.eps"), format='eps')
...
# # plt.grid(True)
# plt.tight_layout()
# plt.savefig(os.path.join(save_dir, "mdot_pcharged_Pr.eps"), format='eps')
...
# # plt.grid(True)
# plt.tight_layout()
# plt.savefig(os.path.join(save_dir, "Qloss_pcharged_Pr.eps"), format='eps')
