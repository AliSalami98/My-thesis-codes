...
input_path = os.path.join(os.path.dirname(__file__), "ss.csv")
...
plt.xlabel(r'Measured COP$_\text{th}$ [-]', fontsize=16)
plt.ylabel(r'Predicted COP$_\text{th}$ [-]', fontsize=16)
...
plt.plot(d_Pheat_out_sorted, 0.85 * d_Pheat_out_sorted, linestyle='--', color='blue', label='15% error')
plt.plot(d_Pheat_out_sorted, 1.15 * d_Pheat_out_sorted, linestyle='--', color='blue')
...
#             c='#8B0000', edgecolor='#8B0000', s=70, label='Sim: Supercritical')
plt.xlabel(r'Measured $\dot{Q}_\text{heat, tot}$ [kW]', fontsize=16)
plt.ylabel(r'Predicted $\dot{Q}_\text{heat, tot}$ [kW]', fontsize=16)
plt.xticks(fontsize=14)
plt.yticks(fontsize=14)
# plt.grid(True)
plt.legend(loc='best', fontsize=14)
